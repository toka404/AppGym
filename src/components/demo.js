...
$(document).ready(function () {
  $("#demoEvoCalendar").evoCalendar({
    ...
    titleFormat: "MM",
    calendarEvents: [
      //para personalizar cada dia modifica esto:
      {
        id: "d8jai7s",
        name: "Snack",
        description: "Juego de la Galleta Oreo! :)",
        date: "October/12/2022",
        type: "birthday",
        everyYear: !0,
      },
      //Plan en 7 dias solo es con el date: []
      {
        id: "sKn89hi",
        name: "Desayuno",
        description:
          "-200g Queso bajo en grasa." +
          "<br/> -Té o Leche sin azucár y leche." +
          "<br/>-1 Fruta (manzana,kiwi,pera,mandarina).",
        badge: "7-días plan",
        date: [
          today.getMonth() +
          1 +
  ...
  $("[data-set-theme]").onclick(function (b) {
    a(b.target);
  });
