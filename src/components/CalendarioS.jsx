...
function Calend() {
    ...
    return (
        ...
        <div className="pt-28 bg-pes ">
            ...
            <svg className="Flecha_Atras_Cal btn" viewBox="0 0 24 29">
                <path id="Flecha_Atras_Cal" d="M 12 0 L 24 29 L 0 29 Z">
                </path>
            </svg>
                    ...
                    <section className="mt-12 md:mt-0 md:pl-14">
                        ...
                        <ol className="mt-4 space-y-1 text-sm leading-6 text-gray-500">
                            {selectedDayMeetings.length > 0 ? (
                                ...
                                <p className="text-blanco font-medium font-poppins text-center">No meetings for today.</p>
                            )}
                        </ol>
                    </section>
                </div>
    ...
    return (
        <li className="flex items-center px-4 py-2 space-x-4 group rounded-xl focus-within:bg-gray-100 hover:bg-gray-100">
            <div className="flex-auto">
                ...
                <p className="text-naranja font-medium font-poppins text-left">{meeting.name}</p>
                {/* Lo que va a comer*/}
                <p className="text-blanco font-medium font-poppins text-left">*{meeting.Description}</p>
            </div>
            <Menu
                as="div"
